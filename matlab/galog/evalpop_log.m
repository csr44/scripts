function Costs=evalpop_log(M,N,N1,Population,BoundaryVals,Constants,Params_type,PreviousCosts);
...
[cost_value,Param_real]=cost_log(Chromozome,N,N1,BoundaryVals,Constants,Params_type);
